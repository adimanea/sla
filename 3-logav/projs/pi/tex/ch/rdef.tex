...
\begin{figure}[!htbp]
    ...
    \begin{tikzpicture}[node distance=0.5cm,
        ...
        \node (sol) [startstop, right=of eq] at (8,0) { \textbf{SOLUȚII} };
        ...
        \node (s1) [right=of e1] at (8,-1) {\texttt{o1 = \{(x,1)\}}};
        \node (s2) [right=of e2] at (8,-2) {\texttt{o2 = \{(x,1), (z,2)\}}};
        \node (s3) [right=of e3] at (8,-3) {\texttt{o3 = \{(x,1), (y,2), (z,3)\}}};
        \node (s4) [right=of e4] at (8,-4) {\texttt{o4 = \{(x,4), (y,2), (z,3), (z,5)\}}};
        \node (s5) [right=of e5] at (8,-5) {\texttt{o5 = \{(x,4), (y,2), (z,5)\}}};
        \node (s6) [right=of e6] at (8,-6) {\texttt{o6 = \{(x,4), (y,2), (z,5)\}}};
        \node (s7) [right=of e6] at (8,-7) {\texttt{o7 = \{(x,4), (y,2), (z,5)\}}};
    \end{tikzpicture}
    \caption{Exemplu pentru definiții accesibile}
    \label{fig:def-epfl}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \begin{tikzpicture}[node distance=0.5cm,
        ...
        \node (s1) [right=of e1] at (8,-1) {\texttt{o1 = \{(x,1)\}}};
        \node (s2) [right=of e2] at (8,-2) {\texttt{o2 = \{(x,1), (z,2)\}}};
        \node (s3) [right=of e3] at (8,-3) {\texttt{o3 = \{(x,3), (y,5), (z,2), (z,4)\}}};
        \node (s4) [right=of e4] at (8,-4) {\texttt{o4 = \{(x,3), (y,5), (z,4)\}}};
        \node (s5) [right=of e5] at (8,-5) {\texttt{o5 = \{(x,3), (y,5), (z,4)\}}};
        \node (s6) [right=of e6] at (8,-6) {\texttt{o6 = \{(x,3), (y,5), (z,4)\}}};
    \end{tikzpicture}
