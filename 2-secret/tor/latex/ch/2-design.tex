...
Rețeaua Tor este una care se adaugă peste rețeaua existentă (eng.\ %
...
OR comunică între ele și cu utilizatorii prin conexiuni TLS cu chei efemere.
...
\todo[inline,noline,backgroundcolor=green!40]{cîte ceva despre Diffie-Hellman}
...
{\color{red} \textbf{Mai departe}}

Detalii despre componente și exemplul de bază de la Jordan Wright +
desenele de la \cite{bs}
