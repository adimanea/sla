  ...
  \begin{figure}[!h]
    ...
    \begin{tikzpicture}
      ...
      \node[basic,below=of bib,xshift=-7em] (edu) {EDU
        ...
        prenume\\
        ...};
      \node[basic,below=of bib,xshift=25em,yshift=-3em] (pub) {PUBLIC
        \nodepart{second}
        \underline{id\_pub}\\
        email\\
        pw};
      ...
      \draw[-{Rays[n=4,length=5mm]}] (edu) -- (fdb) node[midway,Diamond]{lasă};
      \draw[-{Rays[n=4,length=5mm]}] (nedu) -- (fdb) node[midway,Diamond]{lasă};
      \draw[-{Rays[n=4,length=5mm]}] (pub) -- (carte) node[midway,Diamond]{vizualizează};
      \draw[-{Rays[n=4,length=5mm]}] (carte) -- (pub) node[midway,Diamond]{vizualizează};
      ...
      \draw (rev) -- (spec) node[midway,Diamond]{se clasifică după};
      \draw[-{Rays[n=4,length=5mm]}] (rev) -- (spec) node[midway,Diamond]{se clasifică după};
